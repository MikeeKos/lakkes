      ...
      <div className="w-full h-[60rem] lg:h-[30rem] bg-page1 border-2 border-pageMenu">
        <div className="w-full h-full lg:grid lg:grid-cols-2">
          <div className="w-full h-1/2 lg:h-full lg:col-span-1 border-pageMenu p-3">
              ...
              <div className="w-full h-full">
                ...
                <div className="pt-0 md:pt-5 w-full h-2/5 p-3">
                  ...
                  <span className="font-body font-semibold lg:font-normal text-pageMenu text-[9px] min-[360px]:text-[12px] leading-[0px] min-[470px]:text-[16px] sm:text-[20px] md:text-[22px] lg:text-[15px] min-[1200px]:text-[19px]">
                    ...
                    evening by the lake without the hassle of dealing with
                    crowds of people. Share your experiences, tips, and thoughts
                    on any lake by leaving comment. Join this amazing community
                    today and start exploring the beauty of lakes around the
                    world.
                  </span>
                </div>
            ...
            {/* <div className="w-full h-[calc(100%-8rem)] border-4 border-pageMenu scale-75">
              <div className="w-full h-1/3 flex justify-start items-center">
                <span className="pe-5 hover:scale-110 hover:text-page4 duration-200 font-page font-extrabold text-[3.1rem] sm:text-[4rem] md:text-[5rem] lg:text-[5.1rem] leading-none text-pageMenu">
                  hi
                </span>
                <span className="pe-5 hover:scale-110 hover:text-page3 duration-200 font-page font-extrabold text-[3.1rem] sm:text-[4rem] md:text-[5rem] lg:text-[5.1rem] leading-none text-pageMenu">
                  there
                </span>
                <span className="pe-5 hover:scale-110 hover:text-page4 duration-200 font-page font-extrabold text-[3.1rem] sm:text-[4rem] md:text-[5rem] lg:text-[5.1rem] leading-none text-pageMenu">
                  &
              ...
              <div className="w-full h-1/3 flex justify-start items-center">
                <div>
                  <svg
                    ...
                    viewBox="-54 -22.077 47 22"
                    fill="#383434"
                    className="h-[2.8rem] md:h-[4.6rem] lg:h-[4.1rem] hover:scale-125 hover:fill-page4 duration-200"
                  >
                    <path d="M-7-11c-14-3-14-12-17-11s-5 3-8 6c3-2 7-4 8-3 3 3 3 6 17 8m-18 0c-6-3-6-6-11-6-5.333 2.667-6 7-18 11 12-3 12-3 17-7 2-2 5 0 12 2m-16 8c12 7 13 0 18-6 3-3 7-1 9 0-1-1-7-5-10-3-8 6-6 11-17 9"></path>
                  </svg>
                </div>
                <div>
                  <svg
                    ...
                    viewBox="0 -22 107 22"
                    fill="#383434"
                    className="h-[2.8rem] md:h-[4.6rem] lg:h-[4.1rem] hover:scale-125 hover:fill-page3 duration-200"
                  >
                    <path d="M0 0v-22h3v19h10v3H0m16 0l9-22 9 22h-3l-6-15-6 15h-3m21-11l9 11h4l-9-11 9-11h-4l-9 11m16 0l9 11h4l-9-11 9-11h-4l-9 11M70 0h15v-3H70v3m0-10h12v-3H70v3m0-9h15v-3H70v3M98 0c12 0 12-12 0-12-8 0-9-9 6-6l2-2s-2-2-8-2C86-22 86-9 98-9c8 0 8 6 0 6-6 0-8-2-8-2l-2 2s4 3 10 3M0 0"></path>
                  </svg>
                </div>
                  ...
                  <div className="col-span-8 row-span-6 col-start-5 row-start-1 border-4 border-pageMenu z-50 bg-page1">
                    <div className="w-full h-full bg-page1 shadow-2xl">
                      ...
                      <div className="w-full h-4/5 p-1 sm:p-2 overflow-hidden">
                        ...
                        <span className="font-body font-semibold lg:font-normal text-pageMenu text-[9px] min-[360px]:text-[12px] leading-[0px] min-[470px]:text-[16px] sm:text-[20px] md:text-[22px] lg:text-[15px] min-[1200px]:text-[19px]">
                          <span>
                            add a place you've discovered using the form
