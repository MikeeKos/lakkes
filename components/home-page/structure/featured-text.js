...
function FeaturedText() {
  return (
    <div className="relative flex items-center justify-center w-full h-full overflow-hidden">
      ...
      >
        ↓ fetaured ↓ featured ↓ featured ↓ featured ↓ featured ↓ featured ↓
        featured ↓ featured ↓ fetaured ↓ featured ↓ featured ↓ featured ↓
        featured ↓ featured ↓ featured ↓ featured ↓ fetaured ↓ featured ↓
